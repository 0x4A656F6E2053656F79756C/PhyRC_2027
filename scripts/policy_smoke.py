...
parser.add_argument('--output', type=Path, default=Path('/output/policy-smoke'))
...
assert np.isclose(nxt['controller_target'][0,0], .25 * env.M.LIFT_RATE * .4, atol=1e-6)
assert nxt['controller_target'][1,0] == 0

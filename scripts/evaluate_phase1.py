...
if not (ROOT / 'src/DexGarmentLab').is_dir() and Path('/project/src/DexGarmentLab').is_dir():
    ROOT = Path('/project')
...
def main(argv=None):
    ...
    source.add_argument('--input', type=Path, help='Measurement JSON; see docs/PHASE1_EVALUATION.md')
